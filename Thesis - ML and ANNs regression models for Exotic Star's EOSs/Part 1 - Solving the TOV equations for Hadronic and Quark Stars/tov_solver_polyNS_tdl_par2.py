        ...
        if slope<1:
            ...
            for i in range(0,len(Pi_vals)):
                ...
                if P_bound<P_tr:
                    ...
                    break
            break
    results = [Pi_vals,Ei_vals,Ki_vals,P_final]
    return results
...
# for a given EOS
def tov_sol(p_0,ρ_sat,P_sat,r_step,total_EOS_name,main_EOS_func,main_EOS_func_sym,main_dEOS_func,ρ_bounds,Pi_vals,Ei_vals,Ki_vals,Γi_vals):
    ...
    filename = f'{total_EOS_name}L_tdl_sol.csv'
...
def tov_sol_worker(task_id,Γ_selection_coded,Γ_choices,num_segments,main_EOS_name,main_EOS,main_EOS_sym,progress_queue):
    ...
    for i in range(0,total_values):
        ...
        tov_sol(P_0,ρ_sat_MeV,P_sat,R_step,total_EOS_name,main_EOS,main_EOS_sym,main_dEOS,ρ_seg_bounds,Pi_vals,Ei_vals,Ki_vals,Γi_vals)
