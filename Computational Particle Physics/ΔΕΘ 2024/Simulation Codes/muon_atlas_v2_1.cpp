...
// 1) In the directory of the script open a command prompt
// 2) Type ROOT (or root) to start a root session
// 3) Type the command: .L muon_atlas_v2_1.cpp to load the script and press ENTER
// 4) Type the command: main() to use the main function of the script and press ENTER 
